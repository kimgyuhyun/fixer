...
**#29(포인트 원장 코어)는 A·B가 페어로 한다.** 원장 유형 7개 중 5개를 B가, 2개를 A가 부른다. 어느 한쪽만 알면 돈 관련 버그가 그 사람에게 전부 몰린다.
...
## #9 탈퇴한다 (보류 조건 판정)
**담당** A · **선행** #4, #29 · **크기** M · **PRD** auth-member
...
## #12 공고를 등록하면 목록에 뜬다
**담당** B · **선행** #11, #30 · **크기** L · **PRD** job-post
...
**`ADR-JOB-1`(버전 이력 저장 구조)이 결정돼야 착수할 수 있다.**
...
## #16 공고를 취소한다
**담당** B · **선행** #12, #30 · **크기** M · **PRD** job-post
...
**담당** B · **선행** #18, #29 · **크기** M · **PRD** application, point-money
...
## #30 포인트를 충전한다
**담당** B · **선행** #29 · **크기** L · **PRD** point-money
...
## #31 결제를 취소하면 포인트가 회수된다
**담당** B · **선행** #30 · **크기** M · **PRD** point-money
...
## #33 환전을 요청한다
**담당** A · **선행** #23, #32 · **크기** M · **PRD** point-money
...
## #36 관리자가 환전을 승인하고 완료 처리한다
**담당** A · **선행** #33 · **크기** M · **PRD** point-money
...
## #39 중요 알림은 이메일로도 온다
**담당** A · **선행** #38 · **크기** M · **PRD** notification
...
## #40 모집 미달 3시간 전 알림이 오고 공고가 자동 마감된다
**담당** B · **선행** #12, #38 · **크기** M · **PRD** notification
...
L 5개는 전부 "쪼개면 중간에 보여줄 게 없어지는" 것들이다: #7(서명), #12(공고 등록), #13(목록·필터), #29(원장), #30(충전), #34(회원 관리).
...
1. **수직 슬라이스** — 각 이슈가 "완료하면 보여줄 동작이 있는가"를 통과하는가? (#29 원장만 예외 — 화면이 없고 테스트가 데모다)
